...
//                 details: ["+91 7760 777 992", "+91 7760 777 992"],
//                 color: "orange",
//                 bgColor: "orange-50",
//                 action: "Call Now",
//               },
...
export default function ContactPage() {
  ...
  const handleFormSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch("https://formspree.io/f/mldlkobw", {
        method: "POST",
        body: formDataToSend,
        headers: {
                ...
                {showSuccess ? (
                  <div className="text-center py-8">
                    ...
                    <p className="text-slate-600 mb-6">
                      Your inquiry has been submitted successfully. Our team will contact you within 2 hours during
                      business hours.
                    </p>
                    <Button
                  ...
                  <>
                    ...
                    <form onSubmit={handleFormSubmit} className="space-y-6 sm:space-y-8">
                      ...
                      <div>
                        <label className="block text-sm font-semibold text-slate-700 mb-2 sm:mb-3">Full Name</label>
                        <Input
                          name="name"
                          value={formData.name}
                          onChange={handleInputChange}
