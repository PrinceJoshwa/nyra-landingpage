 ...
 <div className="space-y-8 sm:space-y-10">
  {[
    ...
    },
    {
      ...
      subtitle: "Get detailed information and brochures",
      details: [
        { label: "info@nyrasunterra.in", href: "mailto:info@nyrasunterra.in" },
      ...
      details: [
        {
          ...
          href: "https://www.google.com/maps/place/BEML+Cooperative+Society+Layout,+S.Medihalli,+Sarjapur-Attibele+Road,+Bengaluru",
        },
        {
          label: "S.Medihalli, Sarjapur-Attibele Road",
          href: "https://www.google.com/maps/place/BEML+Cooperative+Society+Layout,+S.Medihalli,+Sarjapur-Attibele+Road,+Bengaluru",
        },
        {
          label: "Bengaluru - 562125",
          href: "https://www.google.com/maps/place/BEML+Cooperative+Society+Layout,+S.Medihalli,+Sarjapur-Attibele+Road,+Bengaluru",
        },
      ],
      color: "purple",
          ...
          {contact.details.map((detail, detailIndex) =>
            detail.href ? (
              <a
                ...
                className="block text-slate-700 font-medium leading-relaxed text-sm sm:text-base hover:text-orange-500 transition-colors"
              >
                {detail.label}
              </a>
            ) : (
              <p
                key={detailIndex}
                className="block text-slate-700 font-medium leading-relaxed text-sm sm:text-base"
              >
                {detail.label}
              </p>
            )
