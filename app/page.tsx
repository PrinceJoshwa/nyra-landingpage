...
//         formData.append(
//           "message",
//           "Brochure download request for luxury 5BHK villas (OTP Verified)"
//         );
...
//       submitData.append(
//         "requirements",
//         formData.requirements || "Site visit request"
//       );
//       submitData.append("source", "landing-page");
//       submitData.append(
//         "message",
//         "Site visit booking request for luxury 5BHK villas"
//       );
...
//           title: "Success!",
//           description:
//             "Your tour request has been submitted successfully. We'll contact you soon!",
//           duration: 5000,
//         });
//         setTimeout(() => {
//           setShowContactSuccess(false);
...
//                     </p>
//                     <p className="text-sm text-green-600">
//                       We'll contact you soon with more details about our luxury
//                       5BHK villas.
//                     </p>
//                   </div>
...
//                       {showOtpInput
//                         ? `Verify to download`
//                         : "First, enter your contact number"}
//                     </h5>

//                     <form
//                       onSubmit={
//                         showOtpInput ? handleVerifyAndSubmit : handleSendOtp
//                       }
//                       className="space-y-4"
//                     >
//                       <Input
...
//                           ) : (
//                             <>
//                               <Download className="h-4 w-4 mr-2" /> Verify &
//                               Download
//                             </>
//                           )}
//                         </Button>
...
//                 </div>
//                 <p className="text-base sm:text-lg lg:text-xl xl:text-2xl text-slate-600 leading-relaxed max-w-2xl font-light">
//                   Own a luxurious villa at the price of an apartment in
//                   Sarjapur.Save big on electricity and experience lifestyle
//                   upgradation with gated community accommodating
...
//                       >
//                         <stat.icon
//                           className={`h-3 w-3 sm:h-4 sm:w-4 lg:h-8 lg:w-8 text-${stat.color}-600`}
//                         />
//                       </div>
//                       <div className="text-xl sm:text-2xl lg:text-4xl font-bold text-slate-900 mb-1 sm:mb-2">
//                         {stat.number}
...
//                           your visit to our luxury 5BHK villas.
//                         </p>
//                       </div>
//                       <Button
//                         onClick={() => setShowContactSuccess(false)}
...
//             <div className="w-24 sm:w-32 h-1 bg-gradient-to-r from-orange-600 to-red-600 rounded-full mx-auto mb-6 sm:mb-8"></div>
//             <p className="text-lg sm:text-xl text-slate-600 max-w-4xl mx-auto leading-relaxed font-light">
//               Each villa is meticulously planned to maximize space, natural
//               light, and functionality while maintaining the highest standards
//               of luxury living.
//             </p>
//           </div>
//           <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
...
//                   { name: "Ground Living + Bedroom", sqft: "1,600", active: 0 },
//                   {
//                     name: "First floor Living + 2 Bedrooms",
//                     sqft: "1,400",
//                     active: 1,
//                   },
//                   {
//                     name: "Third floor Living + Bedroom + Cineplex theatre",
//                     sqft: "1,800",
//                     active: 1,
//                   },
//                   { name: "Terrace", sqft: "200", active: 2 },
...
//                         <spec.icon className="h-5 w-5 sm:h-6 sm:w-6 text-orange-600" />
//                       </div>
//                       <div className="font-bold text-sm sm:text-base text-slate-900 mb-1">
//                         {spec.label}
//                       </div>
...
//               </Card>
//               <div className="bg-gradient-to-r from-orange-50 to-red-50 p-6 sm:p-8 rounded-2xl sm:rounded-3xl border border-orange-100">
//                 <h3 className="font-bold text-xl sm:text-2xl text-slate-900 mb-4 sm:mb-6">
//                   Premium Inclusions
//                 </h3>
//                 <div className="grid sm:grid-cols-2 gap-3 sm:gap-4">
//                   {[
...
//             <div className="w-24 sm:w-32 h-1 bg-gradient-to-r from-orange-600 to-red-600 rounded-full mx-auto mb-6 sm:mb-8"></div>
//             <p className="text-lg sm:text-xl text-slate-600 max-w-4xl mx-auto leading-relaxed font-light">
//               Every detail has been meticulously designed to create spaces that
//               inspire, comfort, and elevate your daily living experience to
...
//                   <Button
//                     variant="ghost"
//                     className="p-0 text-slate-700 hover:text-slate-900 font-medium group/btn"
//                   >
//                     Explore Details
//                     <ChevronRight className="h-4 w-4 ml-2 group-hover/btn:translate-x-1 transition-transform" />
//                   </Button>
...
//             <div className="w-24 sm:w-32 h-1 bg-gradient-to-r from-orange-600 to-red-600 rounded-full mx-auto mb-6 sm:mb-8"></div>
//             <p className="text-lg sm:text-xl text-slate-600 max-w-4xl mx-auto font-light">
//               Every amenity has been carefully curated to provide you with a
//               lifestyle that's both luxurious and convenient, setting new
//               standards for premium living.
//             </p>
//           </div>
//           <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
//             {[
...
//                   >
//                     <amenity.icon
//                       className={`h-6 w-6 sm:h-8 sm:w-8 lg:h-10 lg:w-10 text-${amenity.color}-600`}
//                     />
//                   </div>
//                   <h3 className="font-bold text-base sm:text-lg lg:text-xl mb-2 sm:mb-3 lg:mb-4 text-slate-900 tracking-tight">
//                     {amenity.name}
...
//       <section
//         id="location"
//         className="py-12 sm:py-16 lg:py-20 bg-gradient-to-br from-orange-50 to-red-50 relative"
//       >
//         <div className="absolute inset-0 bg-[radial-gradient(circle_at_70%_30%,rgba(251,146,60,0.1),transparent_50%)]"></div>
//         <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
//           <div className="text-center mb-16 sm:mb-20 lg:mb-24">
...
//             <div className="w-24 sm:w-32 h-1 bg-gradient-to-r from-orange-600 to-red-600 rounded-full mx-auto mb-6 sm:mb-8"></div>
//             <p className="text-lg sm:text-xl text-slate-600 max-w-4xl mx-auto font-light">
//               Strategically positioned with seamless connectivity to Bangalore's
//               key destinations, ensuring convenience without compromise
//             </p>
//           </div>
//           <div className="mb-16 sm:mb-20 lg:mb-24">
//             <Card className="overflow-hidden border-0 shadow-2xl rounded-2xl sm:rounded-3xl">
...
//                     >
//                       <category.icon
//                         className={`h-6 w-6 sm:h-8 sm:w-8 text-${category.color}-600`}
//                       />
//                     </div>
...
//             <div className="w-24 sm:w-32 h-1 bg-gradient-to-r from-orange-600 to-red-600 rounded-full mx-auto mb-6 sm:mb-8"></div>
//             <p className="text-lg sm:text-xl text-slate-600 max-w-4xl mx-auto font-light">
//               Schedule a personalized site visit and experience luxury living
//               firsthand with our expert consultants
//             </p>
//           </div>
//           <div className="grid lg:grid-cols-2 gap-12 sm:gap-16 lg:gap-20">
//             <div className="space-y-8 sm:space-y-10 lg:space-y-12">
...
//                     >
//                       <contact.icon
//                         className={`h-6 w-6 sm:h-8 sm:w-8 text-${contact.color}-600`}
//                       />
//                     </div>
//                     <div className="flex-1">
//                       <h3 className="font-bold text-xl sm:text-2xl mb-2 text-slate-900 tracking-tight">
...
//               <Card className="p-6 sm:p-8 lg:p-10 bg-gradient-to-br from-orange-50 to-red-50 border border-orange-200/50 rounded-2xl sm:rounded-3xl shadow-xl">
//                 <div className="text-center">
//                   <h3 className="font-bold text-lg sm:text-xl mb-3 sm:mb-4 text-slate-900">
//                     RERA Registration
//                   </h3>
//                   <div className="bg-white px-4 sm:px-6 py-3 sm:py-4 rounded-xl sm:rounded-2xl shadow-sm border border-orange-100">
//                     <p className="font-mono text-xs sm:text-sm text-slate-700 font-medium break-all">
