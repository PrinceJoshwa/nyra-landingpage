...
export default function AboutUsSection() {
  ...
  // 5. Updated handleFormSubmit function
  const handleFormSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch("https://formspree.io/f/mldlkobw", { // <-- !!! REPLACE THIS !!!
        method: "POST",
      ...
      if (response.ok) {
        ...
        router.push("/enquiry/thankyou") // You can change this path
  ...
  return (
    <section id="about" className="py-12 sm:py-16 lg:py-20 bg-gradient-to-br from-orange-50 to-red-50 relative">
      {/* ... (all other existing JSX remains unchanged) ... */}
